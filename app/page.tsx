...
export default function Home() {
  return (
    <main className="bg-gradient-to-b from-white via-primary-50/40 to-white text-slate-800">
      <section className="mx-auto max-w-6xl px-4 pb-16 pt-8 sm:px-6 lg:px-8 lg:pb-24 lg:pt-12">
        <div className="grid items-center gap-8 rounded-[2rem] border border-primary-100 bg-white p-5 shadow-sm sm:p-8 lg:grid-cols-[1.1fr_0.9fr] lg:p-10">
          <div>
            ...
            <h1 className="mt-5 text-4xl font-black leading-tight tracking-tight text-slate-950 sm:text-5xl">
              勉強の計画倒れを、<br />動画とコーチングで防ぐ。
            </h1>
            <p className="mt-5 text-base leading-8 text-slate-700 sm:text-lg">
              動画で学び、面談で進捗を確認。一人では続きにくい学習を、計画作成・進捗管理・計画修正までサポートします。
            </p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8" id="worries">
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8" id="service">
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8" id="lineup">
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8" id="flow">
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8" id="plans">
